...
export type { IDockerRepository, IDockerTag, IDockerPlatform, IVulnerabilitySummary, IVulnerability, IDockerImageLayer, IDockerImageDetail } from './docker.interfaces';
...
export type { IBulkDeleteRequest, IBulkDeleteItem, IBulkDeleteResult, IBulkDeleteFailure, ICleanupVersionsRequest, IRegistryRepairRequest, IRegistryRepairResult, IRegistryRepairRepository, IRegistryRepairFailure } from './bulk-operations.interfaces';
